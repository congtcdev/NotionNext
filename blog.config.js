...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || 'cd00b74508df454c8792683af8f97edf',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'vn-VN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'congtcdev', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'congtcdev', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'congtc.dev@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/tranchiencongtd', // 你的github个人主页 例如 https://github.com/tangly1024
